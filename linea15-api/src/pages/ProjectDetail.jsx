...
/* ── ComplianceInput — FIX: dependencia onSave en useEffect ─ */
function ComplianceInput({ ctrl, onSave, readOnly }) {
  ...
  // FIX: mantener ref actualizada para evitar stale closure
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',gap:3}}>
      <div style={{display:'flex',gap:5}}>
        ...
        <button className={`btn btn-sm ${listening?'btn-danger':'btn-secondary'}`} onClick={toggleVoice} style={{flexShrink:0,padding:'6px 8px'}} type="button">
        ...
        <div style={{display:'flex',flexDirection:'column',gap:14}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
            {[
              ...
              <button key={i} type="button" onClick={()=>a.action==='export'?onExport():onNavigate(a.action==='approve'?'evidences':a.action)} disabled={a.action==='export'&&exporting}
...
export default function ProjectDetail() {
  ...
  // FIX: handleAddEvidence — e.preventDefault() ya está implícito via onSubmit del form
  ...
  return (
    <>
          ...
          <>
            ...
            <div className="table-wrap card">
              <table style={{tableLayout:'fixed',width:'100%'}}>
                <colgroup>
                  <col style={{width:82}}/>   {/* Código */}
                  <col style={{width:'18%'}}/> {/* Causa base */}
                  <col style={{width:'26%'}}/> {/* Control base */}
                  <col style={{width:72}}/>    {/* RI */}
                  <col style={{width:72}}/>    {/* RR */}
                  <col style={{width:'22%'}}/> {/* Cumplimiento */}
                  <col style={{width:130}}/>   {/* Evidencias */}
                </colgroup>
                <thead>
                  <tr>
                    <th>Código</th>
                    ...
                    return(
                      <tr key={c.id} style={{background:c.compliance?.trim()?'rgba(34,197,94,.03)':'transparent',verticalAlign:'top'}}>
                        ...
                        <td>
                          ...
                          {c.causasAsociadas&&(
                            <ExpandableText text={c.causasAsociadas} maxChars={100} style={{color:'var(--text-muted)',fontSize:'.75rem'}}/>
                          )}
                        </td>
                        <td>
      ...
      {/* FIX: modal evidencia — botón cancelar type="button" para no disparar submit */}
      {evModal&&canAddEv&&(
